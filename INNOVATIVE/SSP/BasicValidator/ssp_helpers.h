...
#define SSP_CMD_FLOAT_AMOUNT 0x3D
...
#define SSP_POLL_PAYOUT_ERROR 0xB1
#define SSP_POLL_PAYOUT_OUT_OF_SERVICE 0xC6
#define SSP_POLL_NOTE_PAID_INTO_STACKER_ON_POWERUP 0xCA
#define SSP_POLL_NOTE_PAID_INTO_STORE_ON_POWERUP 0xCB
#define SSP_POLL_NOTE_HELD_IN_BEZEL 0xCE
