...
namespace eSSP_example
{
    public class CHopper
    {
        ...
        {
            // setup command
            m_cmd.CommandData[0] = CCommands.SSP_CMD_SET_ROUTING;
        ...
        {
            m_cmd.CommandData[0] = CCommands.SSP_CMD_COIN_MECH_GLOBAL_INHIBIT;
        ...
        {
            m_cmd.CommandData[0] = CCommands.SSP_CMD_SET_COIN_AMOUNT;
            // Level to set
        ...
        {
            m_cmd.CommandData[0] = CCommands.SSP_CMD_GET_COIN_AMOUNT;
        ...
        public void IsCoinRecycling(int coinValue, char[] currency, ref bool response, TextBox log = null)
        {
            ...
            m_cmd.CommandData[0] = CCommands.SSP_CMD_GET_ROUTING;
            byte[] b = CHelpers.ConvertInt32ToBytes(coinValue);
            m_cmd.CommandData[1] = b[0];
            m_cmd.CommandData[2] = b[1];
            m_cmd.CommandData[3] = b[2];
        ...
        public void GetCashboxPayoutOpData(TextBox log = null)
        {
            ...
            m_cmd.CommandData[0] = CCommands.SSP_CMD_CASHBOX_PAYOUT_OP_DATA;
            m_cmd.CommandDataLength = 1;
        ...
        public bool CheckGenericResponses(TextBox log = null)
        {
            ...
            else
            {
                if (log != null)
                {
                    ...
                    {
                        case CCommands.SSP_RESPONSE_CMD_CANNOT_BE_PROCESSED:
                        ...
                        case CCommands.SSP_RESPONSE_KEY_NOT_SET:
                            ...
                            return false;
                        case CCommands.SSP_RESPONSE_PARAMS_OUT_OF_RANGE:
                        ...
                        case CCommands.SSP_RESPONSE_COMMAND_NOT_KNOWN:
                            ...
                            return false;
                        case CCommands.SSP_RESPONSE_WRONG_NUMBER_OF_PARAMS:
