...
namespace Get_ATR
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		string rreader,Temp;
		int ATRLen, ReaderLen,Protocol, RecvBuffLen, SendBuffLen;
        Int32 dwState;
		uint PRT;
		short index; 
		...
		private void btnReset_Click(object sender, System.EventArgs e)
		{
            ...
            string readertmp = string.Empty;//new string('\0',100);            
            ReaderLen = rreader.Length+1;

			//perform the Card Status
            retcode = ModWinsCard.SCardStatus(hCard, rreader, ref ReaderLen, ref dwState, ref AProtocol, ref ATR[0], ref ATRLen);
