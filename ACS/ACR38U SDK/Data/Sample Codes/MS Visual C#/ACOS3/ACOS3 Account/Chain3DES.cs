...
namespace ACOSAccount
{
	...
	public class Chain3DES
	{
		...
		public static extern UInt64 Chain_DES(ref byte Data, ref byte key, short TripleDES, int Blocks, int method);
		[DllImport("chaindes.dll")]
		public static extern UInt64 Chain_MAC(ref byte mac, ref byte Data, ref byte key, int Blocks);
		[DllImport("chaindes.dll")]
		public static extern UInt64 Chain_MAC2(ref byte mac, ref byte Data, ref byte key, int Blocks);
