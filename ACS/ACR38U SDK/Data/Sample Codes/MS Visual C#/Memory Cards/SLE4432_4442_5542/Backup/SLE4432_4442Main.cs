...
namespace SLE4432_4442
{
	...
	{	
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(SLE4432_4442Main));
		...
		private void bConnect_Click(object sender, System.EventArgs e)
		{
			...
			if(SLE4432.Checked.Equals(true))
			{
				SendBuff[0] = 0x11;
			}
			else if(SLE4442.Checked.Equals(true))
			{
				SendBuff[0] = 0x12;
			}
