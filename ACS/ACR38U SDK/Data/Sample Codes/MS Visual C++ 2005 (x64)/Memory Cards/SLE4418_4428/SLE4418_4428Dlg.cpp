...
//
//======================================================================
// SLE4418_4428Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "SLE4418_4428.h"
#include "SLE4418_4428Dlg.h"

// ==========================================================================
// SLE4418_4428Dlg include file
#include "Winscard.h"

// SLE4418_4428Dlg GlobalVariables
...
CSLE4418_4428Dlg::CSLE4418_4428Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CSLE4418_4428Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CSLE4418_4428Dlg)
	//}}AFX_DATA_INIT
...
void CSLE4418_4428Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSLE4418_4428Dlg)
	DDX_Control(pDX, IDC_RADIO1, rbSLE4418);
	DDX_Control(pDX, IDC_LIST1, mMsg);
	DDX_Control(pDX, IDC_EDIT4, tData);
	DDX_Control(pDX, IDC_EDIT3, tLen);
	DDX_Control(pDX, IDC_EDIT2, tLoAdd);
	DDX_Control(pDX, IDC_EDIT1, tHiAdd);
	DDX_Control(pDX, IDC_COMBO1, cbReader);
	DDX_Control(pDX, IDC_BUTTON11, bErrCtr);
	DDX_Control(pDX, IDC_BUTTON10, bSubmit);
	DDX_Control(pDX, IDC_BUTTON9, bWriteProt);
	DDX_Control(pDX, IDC_BUTTON8, bWrite);
	DDX_Control(pDX, IDC_BUTTON7, bReadProt);
	DDX_Control(pDX, IDC_BUTTON6, bRead);
	DDX_Control(pDX, IDC_BUTTON5, bQuit);
	DDX_Control(pDX, IDC_BUTTON4, bReset);
	DDX_Control(pDX, IDC_BUTTON3, bConnect);
	DDX_Control(pDX, IDC_BUTTON2, bInit);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CSLE4418_4428Dlg, CDialog)
	//{{AFX_MSG_MAP(CSLE4418_4428Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	...
	ON_BN_CLICKED(IDC_BUTTON7, OnReadProt)
	ON_BN_CLICKED(IDC_BUTTON8, OnWrite)
	ON_BN_CLICKED(IDC_BUTTON9, OnWriteProt)
	ON_BN_CLICKED(IDC_BUTTON10, OnSubmit)
	ON_BN_CLICKED(IDC_BUTTON11, OnErrCtr)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

// ==========================================================================
// SLE4418_4428Dlg internal routines
...
void InitMenu()
{
	...
	pThis->bReadProt.EnableWindow(FALSE);
...
/////////////////////////////////////////////////////////////////////////////
// CSLE4418_4428Dlg message handlers

BOOL CSLE4418_4428Dlg::OnInitDialog()
{
...
void CSLE4418_4428Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSLE4418_4428Dlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIconSmall;
}

void CSLE4418_4428Dlg::OnQuit() 
{
...
void CSLE4418_4428Dlg::OnEditchangeCombo1() 
{
	ClearFields();
	DisableFields();
	bRead.EnableWindow(FALSE);
	bWrite.EnableWindow(FALSE);
	bReadProt.EnableWindow(FALSE);
...
void CSLE4418_4428Dlg::OnRadio1() 
{
	ClearFields();
	DisableFields();
	bRead.EnableWindow(FALSE);
...
void CSLE4418_4428Dlg::OnRadio2() 
{
	ClearFields();
	DisableFields();
	bRead.EnableWindow(FALSE);
...
void CSLE4418_4428Dlg::OnConnect() 
{
	...
	for( i = 0; i < SendLen; i++ )
	{
		sprintf( buffer, "%s %02X", buffer, SendBuff[i] );	
	}
	sprintf( tmpStr, buffer );

	SendAPDUandDisplay( 2, tmpStr );
	if (retCode != SCARD_S_SUCCESS)
	{
        DisplayOut(1, retCode, "");
		connActive = FALSE;
...
void CSLE4418_4428Dlg::OnReadProt() 
{
	int tmpInt, indx, protLen;
	char buffer[256], tmpStr[256];
...
void CSLE4418_4428Dlg::OnWriteProt() 
{
	int tmpInt, indx;
	char buffer[256], tmpStr[256];
...
void CSLE4418_4428Dlg::OnSubmit() 
{
	int tmpInt, indx;
...
void CSLE4418_4428Dlg::OnErrCtr() 
{
