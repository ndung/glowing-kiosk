...
Public Class GetATR
    ...
    Public SendLen, RecvLen As Integer
    Public ReaderLen, ATRLen As Integer
    Public dwState, dwActProtocol As Long
    Public ATRVal(256) As Byte

    Private Sub GetATR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub bGetAtr_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bGetAtr.Click
        ...
        Else
            ...
            For indx = 0 To ATRLen - 1
                ...
                tmpStr = tmpStr + " " + Format(Hex(ATRVal(indx)))
