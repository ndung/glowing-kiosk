...
public class InquiryPaymentPlnNonTagProcessor implements Processor {

    @Override
    public ISOMsg prepareRequest(MessageUtil message) throws ISOException {
        
        String bit48 = "";
        bit48 += StringUtil.padding(message.getCustomerId(), 13, StringUtil.ALIGN_LEFT);
