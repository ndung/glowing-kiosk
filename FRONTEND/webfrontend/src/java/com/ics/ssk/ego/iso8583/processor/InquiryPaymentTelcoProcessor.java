...
public class InquiryPaymentTelcoProcessor implements Processor {
    ...
    public ISOMsg prepareRequest(MessageUtil message) throws ISOException {
        ...
        isoMsg.set(41, StringUtil.padding(message.getKioskId(), 8, StringUtil.ALIGN_LEFT));
        isoMsg.set(48, bit48);
        isoMsg.set(63, bit63);
