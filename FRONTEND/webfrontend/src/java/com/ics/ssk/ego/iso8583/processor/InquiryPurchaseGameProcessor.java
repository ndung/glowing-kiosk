...
public class InquiryPurchaseGameProcessor implements Processor {
    ...
    public ISOMsg prepareRequest(MessageUtil message) throws ISOException {
        ...
        String bit48 = StringUtil.addLeadingZeroes(message.getTotal(), 5);
        bit48 += StringUtil.padding(message.getCustomerId(), 19, StringUtil.ALIGN_LEFT);
