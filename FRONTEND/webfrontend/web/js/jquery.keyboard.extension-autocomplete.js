    ...
    $.fn.addAutocomplete = function(){
        return this.each(function(){
            ...
            base.autocomplete_input = function(event){
                ...
                switch( event.keyCode ) {
                    ...
                    case keyCode.NUMPAD_ENTER:
                        ...
                        if (base.autocomplete_new_version) {
                            base.$autocomplete.menu.select( event );
                        }
                        break;
                    default:
            ...
            base.escClose = function(e){
                ...
                if ( base.hasAutocomplete && (e.target.id === 'ui-active-menuitem' || $(e.target).hasClass('ui-state-focus')) ) {
                    return;
                }
                base.origEscClose(e);
            };
