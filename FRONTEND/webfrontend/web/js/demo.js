jQuery(function($) {
	...
	$('#hex').keyboard({
        ...
        $('#name_adult_1').keyboard({ layout: 'char' });            
        $('#id_adult_1').keyboard({ layout: 'alphanumeric' });
        $('#name_adult_2').keyboard({ layout: 'char' });            
        $('#id_adult_2').keyboard({ layout: 'alphanumeric' });
        $('#name_adult_3').keyboard({ layout: 'char' });            
        $('#id_adult_3').keyboard({ layout: 'alphanumeric' });
        $('#name_adult_4').keyboard({ layout: 'char' });            
        $('#id_adult_4').keyboard({ layout: 'alphanumeric' });
        
        $('#name_child_1').keyboard({ layout: 'char' });            
        $('#name_child_2').keyboard({ layout: 'char' });            
        $('#name_child_3').keyboard({ layout: 'char' });            
        $('#name_child_4').keyboard({ layout: 'char' });            
        
        $('#name_infant_1').keyboard({ layout: 'char' });            
        $('#name_infant_2').keyboard({ layout: 'char' });            
        $('#name_infant_3').keyboard({ layout: 'char' });            
        $('#name_infant_4').keyboard({ layout: 'char' });            
                
        $('#dewasaInput').keyboard({
		layout: 'custom',
		customLayout: {
			'default' : [
				'1 2 3 4',
